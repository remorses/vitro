...
exports.aliasOfPackages = exports.toRequireContextString = exports.toRequireContext = void 0;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _b = (_a = Object).assign;
                    _c = [{}];
                    return [4 /*yield*/, Promise.all(packages.map(function (p) { return __awaiter(_this, void 0, void 0, function () {
                            var pkgPath;
                            var _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        pkgPath = path_1["default"].resolve(__dirname, '.', 'node_modules', 'react');
                                        return [4 /*yield*/, exists(pkgPath)];
                                    case 1:
                                        if (_b.sent()) {
                                            return [2 /*return*/, (_a = {},
                                                    _a[p] = pkgPath,
